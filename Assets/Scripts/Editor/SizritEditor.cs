...
namespace Editor
{
    public class SizritEditor : EditorWindow
    {
        [MenuItem("sizrit/MyEditor")]
        private static void SampleFunc()
        {
            Debug.Log("sizrit");
            
            GetWindow<SizritEditor>("sizrit Editor");
        }
        ...
        {
            StoryBoardDataEditorGraphView graphView = new StoryBoardDataEditorGraphView();
...
//         StoryBoardDataEditor editor = EditorWindow.GetWindow<StoryBoardDataEditor>();
//         editor.Init();
//     }
//    
//     public void Init() {
